...
import de.olafj.vaadin.views.defaulttarget.DefaultTargetView;
import de.olafj.vaadin.views.helloworld.HelloWorldView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("vaadin-router-problem");
